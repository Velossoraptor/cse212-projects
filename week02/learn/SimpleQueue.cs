public class SimpleQueue
{
    public static void Run()
    {
        ...
        // Defect(s) Found: List started at 1 instead of 0
        ...
        value = queue.Dequeue();
        Console.WriteLine(value);
        // Defect(s) Found: enqueueing at the beginning instead of end
    ...
    {
        _queue.Add(value); // switched from insert(0, value) to add(value) at the end
    }
    ...
    private int Dequeue()
    {
        ...
        var value = _queue[0]; //Needed to change to 0 from 1
        _queue.RemoveAt(0);
        return value;
    }
}